...
export default async function ServicePage({ params }: Props) {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white pt-24 pb-20">
      <section className="container mx-auto px-6 mb-16">
        <Link
          href="/#services"
          className="text-gray-500 hover:text-gray-900 dark:text-white mb-6 inline-block text-sm"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 border-t border-gray-800 pt-10">
          ...
          <div className="bg-gray-100 dark:bg-gray-900/50 p-8 rounded-2xl border border-gray-800 h-fit">
