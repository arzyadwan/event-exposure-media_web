      ...
      <div className="w-full h-[50vh] md:h-[70vh] relative bg-gray-900">
        ...
        <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black via-black/80 to-transparent pt-32 pb-10 px-6">
            <div className="max-w-4xl mx-auto">
                <Link href="/portfolio" className="text-gray-400 hover:text-white flex items-center gap-2 mb-4 text-sm font-medium transition-colors">
                    <ArrowLeft size={16} /> Kembali ke Portfolio
                </Link>
                <h1 className="text-4xl md:text-6xl font-bold mb-2">{project.title}</h1>
                <p className="text-xl text-blue-400 font-medium">{project.clientName}</p>
            </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 border-b border-gray-800 pb-10 mb-10">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <p className="text-xs text-gray-500 uppercase tracking-wider">Klien</p>
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="font-semibold">{project.completionDate || "On Going"}</p>
                </div>
            </div>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
            {project.content ? (
                ...
                <p className="text-gray-500 italic">Belum ada detail studi kasus untuk proyek ini.</p>
            )}
        </div>
