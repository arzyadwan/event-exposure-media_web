...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert("Fitur ini perlu diintegrasikan dengan Email Service (misal: Web3Forms/EmailJS).");
  };
    ...
    <main className="min-h-screen bg-black text-white pt-32 pb-20 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          ...
          {/* Tab Switcher */}
          <div className="flex p-1 bg-black rounded-lg mb-8">
            <button
          ...
          {activeTab === "corporate" ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                    ...
                    <input type="text" className="w-full bg-black border border-gray-700 rounded-lg p-3 text-sm focus:border-blue-500 outline-none transition" placeholder="John Doe" />
                </div>
                <div className="space-y-1">
                    <label className="text-xs text-gray-400">Perusahaan</label>
                    <input type="text" className="w-full bg-black border border-gray-700 rounded-lg p-3 text-sm focus:border-blue-500 outline-none transition" placeholder="PT. Maju Mundur" />
                </div>
              </div>
              
              <div className="space-y-1">
                <label className="text-xs text-gray-400">Email Bisnis</label>
                <input type="email" className="w-full bg-black border border-gray-700 rounded-lg p-3 text-sm focus:border-blue-500 outline-none transition" placeholder="john@company.com" />
              </div>

              <div className="space-y-1">
                <label className="text-xs text-gray-400">Kebutuhan</label>
                <select className="w-full bg-black border border-gray-700 rounded-lg p-3 text-sm focus:border-blue-500 outline-none transition text-gray-300">
              ...
              <div className="space-y-1">
                ...
                <textarea rows={4} className="w-full bg-black border border-gray-700 rounded-lg p-3 text-sm focus:border-blue-500 outline-none transition" placeholder="Ceritakan project Anda..." />
              </div>
            ...
            <div className="text-center py-10 space-y-6">
                ...
                <div>
                    <h3 className="text-xl font-bold mb-2">Respon Cepat via WhatsApp</h3>
                    <p className="text-gray-400 text-sm px-8">
                        Untuk kebutuhan Wedding, Foto Wisuda, atau Personal Branding, tim kami lebih cepat merespon melalui chat instan.
                    </p>
                </div>
                <a 
                    href="https://wa.me/6281234567890?text=Halo%20Event%20Exposure,%20saya%20ingin%20tanya%20jasa..."
                    target="_blank"
                    className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-full transition transform hover:scale-105"
                >
